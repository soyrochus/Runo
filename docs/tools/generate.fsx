...
let referenceBinaries = [ "runo.dll" ]
// Web site location for the generated documentation
let website = "/runo"

let githubLink = "http://github.com/soyrochus/runo"

// Specify more information about your project
let info =
  [ "project-name", "runo"
    "project-author", "Iwan van der Kleijn"
    "project-summary", @"Runo ('runes') - Magic words for F#"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/runo" ]
